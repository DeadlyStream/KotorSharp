...
namespace AuroraIO {
    public class ItemBlueprintObject : GFFObject {
        ...
        public ItemBlueprintObject(AuroraResourceType fileType) : base(fileType) {
        }

        public void addProperty(ItemBlueprintPropertyInfo info) {
            var propertiesList = fields["PropertiesList"] as GFFListDataObject;
            propertiesList.structInfoArray.Add(GFFElementFactory.propertyStruct(info));
        }
