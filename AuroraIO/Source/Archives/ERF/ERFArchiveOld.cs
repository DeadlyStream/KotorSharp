...
namespace AuroraIO.Source.Archives.ERF {
    public class ERFArchiveOld: AuroraResourceCollection {
        ...
        public ERFArchiveOld(AuroraResourceType resourceType) {
            this.fileType = resourceType;
            this.fileVersion = "V1.0";
        }

        public ERFArchiveOld(string filePath) : this(File.ReadAllBytes(filePath) ) {
            this.filePath = filePath;
        }

        public ERFArchiveOld(byte[] fileArray) {
            //FileType
